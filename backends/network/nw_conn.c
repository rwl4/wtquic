 ...
 *
 * Grounded in measured Network.framework behavior (summarized in
 * COMPATIBILITY.md) and §§2-7 of the stream-identity design:
 *
 ...
 *    unreliable — peer-observed). NW's own hidden client-initiated
